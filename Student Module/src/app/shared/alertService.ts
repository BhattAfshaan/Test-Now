  ...
  showSuccessAlert(callback: () => void, isSuccess: boolean) {
    Swal.fire({
      ...
      text: isSuccess
        ...
        : this.messages.ConfirmMessage,
      icon: isSuccess
        ? this.messages.SuccessIcon
        : (this.messages.ConfirmIcon as any),
      showConfirmButton: true,
      confirmButtonText: isSuccess
        ? this.messages.SuccessButton
        : this.messages.ConfirmButton,
      backdrop: true,
